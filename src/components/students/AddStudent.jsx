        ...
        <React.Fragment>
            ...
            <div className={classes.root} >
                <Grid container direction="row" justify="space-between" alignItems="flex-end">
                    <Grid item className={classes.header}>Add Student</Grid>
                ...
                <Formik
                        ...
                        onSubmit={(data, { setSubmitting }) => {
                            setSubmitting(true);                 
                            dispatch({type:'ADD_STUD',student:{firstName:data.firstName, lastName:data.lastName, dob:data.dob, email: data.email}});
                            console.log(student);
                             history.push({
                             pathname:'/Students',
